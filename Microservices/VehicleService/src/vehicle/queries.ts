...
select permitInfo.permit_id, permitInfo.permitType, permitInfo.issueDate, permitInfo.expDate, permitInfo.isValid
from vehicle v
LEFT JOIN 
  dblink('dbname=permit user=postgres',
    'select dp.driver AS driverID, dp.id AS permitID, pt.data->>'type' AS permitType, dp.data->>'issue_date' AS issueDate,
